<div class="container-fluid">
	<div class="hapus-alert">
	</div>
	<button class="btn btn-primary mt-3 mb-3" id="btnTambahKaryawan"><i class="fas fa-plus"></i> Tambah Data
		Karyawan</button>

	<div class="row">
		<div class="col">
			<table class="table display responsive nowrap table-striped" style="width:100%" id="tableKaryawan">
						...
						<div class="col-12">
							<div class="form-group">
								...
								<div class="form-check form-check-inline">
									<input class="form-check-input" type="radio" name="gender" id="rdL" value="L">
									<label class="form-check-label" for="rdL">Laki-laki</label>
								</div>
								<div class="form-check form-check-inline">
									<input class="form-check-input" type="radio" name="gender" id="rdP" value="P">
					...
					<div class="row">
						...
						<div class="col-6">
							<div class="form-group">
								...
								<input type="text" class="form-control" id="telp" name="telp" maxlength="20">
