<div class="container-fluid">
	...
	<button class="btn btn-primary mt-3 mb-3" id="btnTambahSubKriteria"><i class="fas fa-plus"></i> Tambah Sub
		Kriteria</button>

	<div class="row">
		<div class="col">
			<table class="table display responsive nowrap table-striped" style="width:100%" id="tableSubKriteria">
